...
contract MantleSepoliaUSDT {
    string public name = "MantleSepoliaMockUSDT";
    ...
    // 🔎 View contract MNT balance
    function contractBalance() external view returns (uint) {
        return address(this).balance;
    }

    // ✅ Accept MNT sent directly to contract
