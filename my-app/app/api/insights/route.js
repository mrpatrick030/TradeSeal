...
export async function POST(req) {
  try {
    ...
    // Construct AI prompt
    const prompt = `
You are an expert analytics assistant for a Mantle blockchain decentralized on-chain marketplace called TradeSeal.
...
- View mode tells the kind of user interacting currently if he is getting global TradeSeal insights, as a buyer getting buyer insights (make it personal as in "you"), or as a seller getting seller insights(make it personal as in "you").
...
`;
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are a data analytics expert summarizing insights for a Mantle blockchain decentralized on-chain marketplace dashboard.",
        },
