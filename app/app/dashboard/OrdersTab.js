...
const dropdownRef = useRef(null);
  ...
  // Buyer: confirm & pay (handles MNT vs token)
const ERC20_ABI = [
    ...
    async (values) => {
      ...
      try {
        ...
        const metadata = {
          ...
          description: `Receipt NFT for order #${orderId} on TradeSeal`,
